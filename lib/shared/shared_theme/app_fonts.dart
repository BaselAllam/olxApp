...
class AppFonts {
  ...
  static TextStyle primaryBlacTextStyle = TextStyle(color: AppColors.blackColor, fontSize: 20.0, fontWeight: FontWeight.bold);
  static TextStyle primaryGreyTextStyle = TextStyle(color: AppColors.greyThreeColor, fontSize: 20.0);
  static TextStyle subBlacTextStyle = TextStyle(color: AppColors.blackColor, fontSize: 15.0);
  static TextStyle miniBlacTextStyle = TextStyle(color: AppColors.blackColor, fontSize: 10.0);
